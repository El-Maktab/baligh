import type { DictionaryBootstrap, DictionaryEntry } from "./types";
...
export const dictionaryBootstrap: DictionaryBootstrap = {
  initialQuery: "بليغ",
  featuredEntry: dictionaryEntries[0]!,
  recentSearches: ["بليغ", "استنبط", "جذر", "متوارث"],
};
