import { normalizeArabic } from "../mo3gm/mockData";
import type { GrammarRule, RuleCategory, RuleCategoryOption } from "./types";

export const ruleCategories: RuleCategoryOption[] = [
