    ...
    corrections: [
      {
        ...
        taxonomyCode: "OT:diacritics",
        taxonomyLabel: "diacritics",
      ...
      },
      {
        ...
        taxonomyCode: "OT:word_choice",
        taxonomyLabel: "word choice",
        sourceModule: "DICTIONARY",
        confidence: 0.88,
      },
      {
        ...
        taxonomyCode: "SY:verb_form",
        taxonomyLabel: "verb form",
        sourceModule: "ONTOLOGY",
        confidence: 0.81,
      },
      {
        id: "correction-4",
        ...
        taxonomyCode: "SE:repetition",
        taxonomyLabel: "repetition",
        sourceModule: "TAG",
        confidence: 0.75,
      },
      {
