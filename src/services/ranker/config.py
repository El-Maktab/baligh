"""Ranker configuration with weighted scoring parameters."""
...
class RankerConfig(BaseModel):
    """Weighted scoring configuration for the ranker."""
...
def get_ranker_config(path: Path | str | None = None) -> RankerConfig:
    """Return the global RankerConfig, loading from YAML on first call."""
