...
from src.services.nws.features.nwp.lstm.model import PAD_ID, ArabicLSTMLM
...
def train(base_dir: str, sp_model_path: str):
    ...
    for epoch in range(1, CFG["epochs"] + 1):
        ...
        print(
            f"Epoch {epoch} | train_loss={train_loss:.4f} | val_loss={val_loss:.4f} | val_ppl={val_ppl:.2f}"
        )
