...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="CALM/arwiki", help="HuggingFace dataset name")
    parser.add_argument("--max-rows", type=int, default=100000, help="Maximum number of rows to process")
    ...
    parser.add_argument("--output", type=str, required=True, help="Output path for the .msgpack.gz file")
