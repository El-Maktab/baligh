...
from src.services.gec.modules.edit_tagger.crf.model_loader import load_model_with_optional_crf
...
def main():
    ...
    parser.add_argument("--output_dir", default=str(Path(__file__).resolve().parents[2] / "modules" / "models" / "edit_tagger_v1"))
