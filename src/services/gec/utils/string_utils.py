...
class Tokenizer:
    """Wrapper around the AraBERT tokenizer for subword tokenization and encoding."""

    def __init__(self):
        """Initialize the Tokenizer with the AraBERT base model."""
    ...
    def get_token_id(self, tokens: list[str]) -> list[int]:
        """Convert subword tokens to their vocabulary ids."""
